      ...
      DisplaysError
{
   ...
   private static presentCart(cartOutput: PresentableCart): CartViewModel {
      return {
         ...
         discount: ShopPresenter.formatGermanPrice(cartOutput.discount),
         discountInPercent: cartOutput.discountInDecimal * 100,
      ...
      if (this._state.aside) {
         dto.aside = {
            cart: this._state.aside.cart && {
               ...
               discount: this._state.aside.cart.discount,
               discountInPercent: this._state.aside.cart.discountInPercent,
